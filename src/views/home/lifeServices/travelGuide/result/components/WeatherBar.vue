...
.weather-bar {
  ...
  &.rainy { background: linear-gradient(135deg, #fef2f2, #fff7ed); border-color: #fecaca; }
  &.loading { opacity: 0.7; font-size: 13px; color: #64748b; }

  // 弹窗模式
  &.dialog-mode {
    border: none; border-radius: 0; box-shadow: none;
    padding: 20px 28px 28px; margin-bottom: 0;
    background: #fff;
  }
}
...
.weather-temp { font-weight: 700; color: #0f172a; min-width: 40px; }
.weather-desc { color: #475569; font-weight: 500; }
.weather-wind { font-size: 12px; color: #64748b; margin-left: auto; }
...
.weather-forecast {
  ...
  .dialog-mode & { border-top: 1px solid #f1f5f9; margin-top: 0; padding-top: 18px; }
}
.forecast-title {
...
.expand-enter-from, .expand-leave-to {
  opacity: 0; max-height: 0; padding-top: 0; padding-bottom: 0; border-width: 0;
}
.expand-enter-to, .expand-leave-from {
  opacity: 1; max-height: 600px;
}
.forecast-detail-hourly .detail-subtitle {
...
.forecast-detail-cards { display: grid; gap: 8px; }
.detail-card {
  display: flex; gap: 12px;
  padding: 12px 14px;
  border-radius: 10px;
  &.day { background: linear-gradient(135deg, #fff7ed, #fffbeb); border: 1px solid #fde68a; }
  &.night { background: linear-gradient(135deg, #eff6ff, #f0f9ff); border: 1px solid #bfdbfe; }
}
.detail-card-header { font-size: 13px; font-weight: 600; color: #475569; flex-shrink: 0; min-width: 50px; }
